...
ggplot(data = 
         ...
         mutate(
           ...
           dtu_linear_method_2 = 
             pmap_dbl(list(T_air_min,
                           ...
                           method),
                      t_daily_thermal_unit),
           cover_crop = str_replace_all(string = cover_crop,
                                        pattern = "cereal_rye",
                                        replacement = "Cereal rye")
         ) %>%
         filter(cover_crop %in% c("Cereal rye")) %>% 
  ...
  coord_cartesian(xlim = c(-10,50),
                  ylim = c(0,50)) +
  labs(color = "Daily thermal unit method") +
